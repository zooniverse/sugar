...
var Bluebird, MockPrimus, SugarClient, chai, expect,
...
describe('SugarClient', function() {
  ...
  describe('#receiveData', function() {
    ...
    return describe('with a connection', function() {
      ...
      return it('should subscribe to channels', function() {
        return Bluebird.delay(100).then(function() {
          return expect(userClient.__subscribeToChannels).to.have.been.called();
        });
      });
    });
  });
  ...
  describe('#on', function() {
    return it('should add the event', function() {
      var fn;
      fn = function() {};
  ...
  return describe('#createEvent', function() {
