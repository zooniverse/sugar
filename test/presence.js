...
var Bluebird, Presence, chai, expect, presence;
...
describe('Presence', function() {
  ...
  createSamples = function() {
    return Bluebird.all([active('user:1', 'test1'), active('user:1', 'zooniverse'), active('user:2', 'test2'), active('user:2', 'zooniverse'), active('session:3', 'test3'), active('session:3', 'zooniverse')]);
  };
