...
var Presence = (function() {
  ...
  Presence.prototype.userActiveOn = function(channel, userKey) {
    if(this._isUserChannel(channel)) return;
  ...
  Presence.prototype.clearInactive = function() {
    ...
    var twoMinutesAgo = -2 * 60 * 1000 + (+new Date());
  ...
  Presence.prototype.usersOn = function(channel) {
    return this._scan({ method: 'zscan', key: 'presence:' + channel, pattern: 'user:*' }).then(function(values) {
  ...
  Presence.prototype._isUserChannel = function(channel) {
