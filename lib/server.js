...
var Server = (function() {
  ...
  Server.prototype.notifyAction = function(req, res) {
    ...
    var params = req.body;
    this.db.createNotification(params).then(function(notification) {
  ...
  Server.prototype.clientGetNotifications = function(params) {
    this.db.getNotifications(params).then(function(notifications) {
  ...
  Server.prototype.clientReadNotifications = function(params) {
    this.db.markNotificationsRead(params.ids);
  };
