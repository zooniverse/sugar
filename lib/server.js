...
var Server = (function() {
  ...
  Server.prototype.notifyAction = function(req, res) {
    ...
    var params = req.body;
    this.notifications.createNotification(params).then(function(notification) {
      this.renderJSON(res, { success: true });
      return notification[0];
    }.bind(this)).then(function(notification) {
  ...
  Server.prototype.clientGetNotifications = function(params) {
    this.notifications.getNotifications(params).then(function(notifications) {
  ...
  Server.prototype.clientReadNotifications = function(params) {
    this.notifications.markNotificationsRead(params.ids);
  };
