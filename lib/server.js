...
var Bluebird, Panoptes, Presence, Primus, PubSub, basicAuth, bodyParser, cors, express, http, morgan;
...
class Server {
  ...
  authenticate(spark) {
    ...
    Panoptes.authenticator(spark.query.user_id, spark.query.auth_token).then(function(result) {
