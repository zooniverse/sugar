...
var Notifications = (function() {
  ...
  Notifications.prototype.get = function(opts) {
    ...
    var selector = this._get_selector(opts);
    if(!selector.user_key) return this.pg.emptySet();
  ...
  Notifications.prototype._get_selector = function(opts) {
    var selector = { };
    if(opts.unread) selector.is_delivered = false;
