...
var Notifications = (function() {
  ...
  Notifications.prototype.createNotification = function(notification) {
  ...
  Notifications.prototype.getNotifications = function(opts) {
  ...
  Notifications.prototype.markNotificationsRead = function(ids) {
    if(!ids || ids.length == 0) return;
    return this.knex('notifications').whereIn('id', ids).update('is_delivered', true).exec();
  }
